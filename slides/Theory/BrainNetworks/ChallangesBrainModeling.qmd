...
:::: {.columns}
:::{.column width=50% style="margin-top: 0px;  margin-bottom: 0px; font-size: 0.8em;"}
...
:::
:::{.column width=50% layout="[[-1],[1],[-1]]" style="margin-top: 0px;  margin-bottom: 0px; font-size: 0.6em;"}
